...
export default function AuthLayout({
    ...
    return (
        <div className="h-screen w-full flex bg-background font-sans overflow-hidden">
            ...
            {/* Image Side - RIGHT (Visually) - 30% width */}
            <div className="hidden lg:block w-[30%] relative overflow-hidden h-screen order-1 bg-gradient-to-br from-footer via-footer to-footer">
                {/* Subtle Mesh Pattern */}
                ...
                {/* Soft Glow Effects */}
                <div className="absolute top-0 left-0 w-64 h-64 bg-emerald-green-pale/50 rounded-full blur-3xl" />
                <div className="absolute bottom-0 right-0 w-48 h-48 rounded-full blur-3xl" style={{
                    backgroundColor: 'hsl(var(--golden-orange) / 0.1)'
                }} />
                    ...
                    <div>
                        <Link href="/" className="flex items-center gap-2 w-fit group">
                            <img
                                src="/logo.png"
                                alt="عون"
                                className="h-14 w-auto object-contain opacity-90 group-hover:opacity-100 transition-all duration-300"
                            />
                        </Link>
                    </div>
            ...
            {/* Form Side - LEFT (Visually) - 70% width - Hidden Scrollbar */}
            <div className="w-full lg:w-[70%] flex flex-col relative bg-background h-screen overflow-hidden order-2">
                {/* Background Pattern */}
                <div className="absolute inset-0 z-0 opacity-[0.4] pointer-events-none bg-[radial-gradient(hsl(var(--border-light))_1px,transparent_1px)] [background-size:16px_16px] dark:bg-[radial-gradient(hsl(var(--border-dark))_1px,transparent_1px)]" />
                ...
                <div className="flex-1 overflow-y-auto overflow-x-hidden flex items-start justify-center px-4 pt-20 pb-12 lg:px-8 lg:pt-32 lg:pb-12 scrollbar-hide">
