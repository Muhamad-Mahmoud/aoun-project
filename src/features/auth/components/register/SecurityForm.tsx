                ...
                <div className="space-y-8 relative z-10">
                    ...
                    <div className="relative group">
                        ...
                        <button
                            ...
                            className="absolute left-4 top-[52px] text-slate-400 hover:text-primary transition-colors"
                        >
                    ...
                    <div className="pt-2 border-t border-slate-50">
                        <div className="flex items-start gap-3 group cursor-pointer" onClick={() => onChange("acceptTerms", !formData.acceptTerms)}>
                            <div className="mt-1">
                                <Checkbox
                                    id="acceptTerms"
                                    checked={formData.acceptTerms}
                                    onCheckedChange={(val) => onChange("acceptTerms", !!val)}
                                    className="w-6 h-6 rounded-lg border-2 border-slate-200 data-[state=checked]:bg-primary data-[state=checked]:border-primary transition-all pointer-events-none"
                                />
                            </div>
                            <div className="space-y-1">
                                <Label
                                    htmlFor="acceptTerms"
                                    className="text-base font-bold text-slate-700 cursor-pointer group-hover:text-slate-900 transition-colors"
                                >
