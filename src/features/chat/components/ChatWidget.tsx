...
export function ChatWidget() {
    ...
    return (
        <>
            ...
            <div
                className={cn(
                    "fixed bottom-[88px] sm:bottom-[104px] w-[92vw] sm:w-[420px] h-[600px] max-h-[80vh] bg-background/95 backdrop-blur-xl rounded-[24px] sm:rounded-[32px] shadow-[0_25px_60px_rgba(0,0,0,0.2)] border border-white/20 overflow-hidden transition-all duration-500 origin-bottom-left flex flex-col",
                    isOpen 
                        ? "opacity-100 scale-100 translate-y-0 pointer-events-auto visible z-[9999]" 
                        : "opacity-0 scale-90 translate-y-10 pointer-events-none invisible -z-50"
                )}
                dir="rtl"
