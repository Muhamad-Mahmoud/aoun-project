    ...
    return (
        <div className="space-y-5">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <span className={cn(
                                            ...
                                            isActive ? "bg-emerald-100 text-emerald-600" : `${cat.bg} ${cat.color} group-hover:opacity-90`
                                        )}>
                                ...
                                <FormItem className="text-start">
                                    ...
                                    <FormControl>
                                        <Textarea
                                            ...
                                            className="rounded-xl min-h-[80px] text-[14px] border border-slate-200 bg-white focus:ring-2 focus:ring-warm-green/15 focus:border-warm-green/50 transition-all resize-none px-4 py-3 placeholder:text-slate-400"
                                            {...field}
                                            value={field.value ?? ""}
                                        />
                                    </FormControl>
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem className="text-start">
                        <FormLabel className="text-[13px] font-bold text-slate-700 mb-1.5 flex items-center gap-2">
                        ...
                        <FormControl>
                            <div className="relative">
                                <Textarea
                                    ...
                                    className="min-h-[120px] text-[14px] rounded-xl p-4 border-slate-200 bg-white focus:ring-2 focus:ring-warm-green/15 focus:border-warm-green/50 transition-all resize-none leading-relaxed placeholder:text-slate-400"
                                    {...field}
                                    value={field.value ?? ""}
                                />
                                <div className="absolute left-3 bottom-2.5 pointer-events-none">
                                    <span className={cn(
                                        ...
                                        (field.value?.length || 0) > 1800 ? "bg-rose-100 text-rose-500" : "bg-slate-100 text-slate-400"
                                    )}>
